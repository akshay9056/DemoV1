...
const hasCustomerTFN = Array.isArray(inputValues?.["customerNumber"]) 
  && inputValues["customerNumber"].some(value => value?.trim?.() !== "");
          ...
          // console.log("hasInteractionFilter");
          // console.log(hasInteractionFilter);
          // console.log("hasRingGroupFilter");
          // console.log(hasRingGroupFilter);
          // console.log("hasTalkdeskTFN");  
          // console.log(hasTalkdeskTFN);
          // console.log("hasAgentName");
          // console.log(hasAgentName);
          // console.log("hasCustomerTFN");  
          // console.log(hasCustomerTFN);
          ...
          const matchesDateRange = hasDateRange
            ? (() => {
                ...
                // console.log(vl["Call Start Time"]);
                // console.log(recordDate);
                // console.log(fromDate);    
                // console.log(toDate);
                // console.log(recordDate >= fromDate && recordDate <= toDate)
